...
public class Mc_Neusoft_Func {
	...
	public static String[] outFileNames = { "${TABLE_NAME_JAVA}.java", "${TABLE_NAME_JAVA}VO.java",
			...
			"${TABLE_NAME}.sql", "config.txt", modulePack+"_${SUBMODEL_NAME_LOWER}_list.jsp", modulePack+"_${MODULE_NAME_LOWER}_list.js",
			modulePack+"_${MODULE_NAME_LOWER}_edit.jsp", modulePack+"_${MODULE_NAME_LOWER}_edit.js", "${TABLE_NAME_JAVA}Service.java",
