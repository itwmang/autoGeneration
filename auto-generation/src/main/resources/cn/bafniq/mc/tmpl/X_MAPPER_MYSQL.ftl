...
<mapper namespace="${basePack}.core.dao.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}Mapper">
	...
	<insert id="save" <#if table.pkColumn.typeJava=="Long">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" <#elseif table.pkColumn.typeJava=="Integer">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" </#if>parameterType="${basePack}.mode.entity.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU};">
