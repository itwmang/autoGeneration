...
<mapper namespace="${basePack}.${modulePack}.core.dao.${table.modelNameLow}.${table.tableNameJavaFU}Mapper">
	...
	<insert id="save" <#if table.pkColumn.typeJava=="Long">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" <#elseif table.pkColumn.typeJava=="Integer">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" </#if>parameterType="${basePack}.${modulePack}.api.entity.${table.modelNameLow}.${table.tableNameJavaFU};">
