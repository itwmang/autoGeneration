...
<mapper namespace="${basePack}.${modulePack}.core.dao.${table.modelNameLow}.${table.tableNameJavaFU}Mapper">
	...
	<resultMap id="baseResultMap" type="${basePack}.${modulePack}.api.entity.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<insert id="save" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.${modulePack}.api.entity.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<insert id="insertWithSequence" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.${modulePack}.api.entity.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<update id="update" parameterType="${basePack}.${modulePack}.api.entity.${table.modelNameLow}.${table.tableNameJavaFU}">
		update ${table.tableNameLow}
