...
<mapper namespace="${basePack}..core.dao${modulePack}.${table.tableNameJavaFU}Mapper">
	...
	<insert id="save" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.mode.entity.${modulePack}.${table.tableNameJavaFU}">
	...
	<insert id="insertWithSequence" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.mode.entity.${modulePack}.${table.tableNameJavaFU}">
