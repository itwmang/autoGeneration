...
<mapper namespace="${basePack}..core.dao${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}Mapper">

	<!-- ********************** 以下部分为代码自动生成，不能修改！！！ ********************************** -->

	<resultMap id="baseResultMap" type="${basePack}.mode.entity.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<insert id="save" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.mode.entity.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<insert id="insertWithSequence" useGeneratedKeys="false" keyProperty="${table.pkColumn.nameJavaFL}" parameterType="${basePack}.mode.entity.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}">
	...
	<update id="update" parameterType="${basePack}.mode.entity.${modulePack}.${table.modelNameLow}.${table.tableNameJavaFU}">
		update ${table.tableNameLow}
