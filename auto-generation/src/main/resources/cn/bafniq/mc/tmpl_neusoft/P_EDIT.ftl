...
<script type="text/javascript">
	var vModel=${r"$"}{empty modelFromServer?"{}":modelFromServer};
	var vFormFields=[
	...
	$(document).ready(function () {
		...
		$("#btnSave").click(function () {
			...
			vParam["${table.pkColumn.nameJavaFL}"]=vModel["${table.pkColumn.nameJavaFL}"];
			
			var vData=midea_ajax_lib.post(ctx+"/${table.modelNameLow}/update",vParam);
