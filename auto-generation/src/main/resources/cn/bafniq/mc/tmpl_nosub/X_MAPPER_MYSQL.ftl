...
<mapper namespace="${basePack}.${modulePack}.core.dao.${table.tableNameJavaFU}Mapper">
	...
	<insert id="save" <#if table.pkColumn.typeJava=="Long">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" <#elseif table.pkColumn.typeJava=="Integer">useGeneratedKeys="true" keyProperty="${table.pkColumn.nameJavaFL}" </#if>parameterType="${basePack}.${modulePack}.mode.entity.${table.tableNameJavaFU};">
